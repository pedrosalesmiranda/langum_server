...
from expressions_generation_scripts.gpt_prompts.prompt_generation import generate_pack_meanings_prompt, generate_expressions_prompt, generate_phonetics_prompt
...
# TODO REFACTOR: THIS METHODS HAVE REPEATED CODE that can extracted and shared //////////////////////////////////////////////////////////////////////
def create_all_from_json_meanings(target_lang: str, base_lang):
    input_folder_path = shared.constants.JSON_INPUT_FOLDER_PATH
    data = shared.json_utils.load_json_file(shared.constants.PACK_MEANINGS_JSON_FILENAME_NO_EXTENSION,
...
def create_expressions_from_json():
    ...
    expressions = shared.json_utils.load_json_file(filename_no_extension, folder_path=shared.constants.JSON_INPUT_FOLDER_PATH)
...
def create_phonetics_from_json(language_eng: str):
    ...
    phonetics = shared.json_utils.load_json_file(filename_no_extension, folder_path=shared.constants.JSON_INPUT_FOLDER_PATH)
